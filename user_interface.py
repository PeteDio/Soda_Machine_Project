...
def display_welcome():
    """Initial method asking user if they'll make a purchase."""
...
def clear_console():
    """Used for clearing out the console"""
...
def soda_selection(inventory):
    """Displays purchasable soda inventory and returns selected can"""
...
def validate_can_choice(selection, unique_cans):
    """Translates user menu selection into the name of can that was chosen."""
